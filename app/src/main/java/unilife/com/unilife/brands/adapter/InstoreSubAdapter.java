...
public class InstoreSubAdapter extends RecyclerView.Adapter<InstoreSubAdapter.MyViewHolder> {
    ArrayList<BrandDetailsResponse.Store> arrayList;
    Context context;

    // Provide a suitable constructor (depends on the kind of dataset)
    public InstoreSubAdapter(Context context, ArrayList<BrandDetailsResponse.Store> categoriesBrand) {
    ...
    @Override
    public InstoreSubAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
