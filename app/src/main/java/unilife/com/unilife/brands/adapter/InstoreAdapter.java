...
import unilife.com.unilife.brands.InstoreRedeemActivity;
...
public class InstoreAdapter extends RecyclerView.Adapter<InstoreAdapter.MyViewHolder> {
    ArrayList<BrandDetailsResponse.Store> arrayList;
    Context context;

    // Provide a suitable constructor (depends on the kind of dataset)
    public InstoreAdapter(Context context, ArrayList<BrandDetailsResponse.Store> arrayList) {
...
//        holder.txtHeader.setText(arrayList.get(position).getName());
        ...
        holder.btnRedeem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, InstoreRedeemActivity.class);
