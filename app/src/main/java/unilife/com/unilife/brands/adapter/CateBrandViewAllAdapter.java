...
public class CateBrandViewAllAdapter extends RecyclerView.Adapter<CateBrandViewAllAdapter.MyViewHolder> {
    ArrayList<CategoryWiseBrandResponse.Offer> categoriesBrand;
    Context context;

    // Provide a suitable constructor (depends on the kind of dataset)
    public CateBrandViewAllAdapter(Context context, ArrayList<CategoryWiseBrandResponse.Offer> categoriesBrand) {
    ...
    @Override
    public CateBrandViewAllAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        // create a new view
...
//                    .apply(defultImg)
        ...
        Log.e("title", categoriesBrand.get(position).getBrandName());
