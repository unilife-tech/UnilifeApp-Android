...
public class BrandViewAllAdapter extends RecyclerView.Adapter<BrandViewAllAdapter.MyViewHolder> {
    ArrayList<BrandResponse2.CategoriesBrand> categoriesBrand;
    Context context;

    // Provide a suitable constructor (depends on the kind of dataset)
    public BrandViewAllAdapter(Context context, ArrayList<BrandResponse2.CategoriesBrand> categoriesBrand) {
    ...
    @Override
    public BrandViewAllAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                               int viewType) {
        // create a new view
