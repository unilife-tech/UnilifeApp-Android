...
public class PollAdapter extends RecyclerView.Adapter<PollAdapter.MyViewHolder> {
    ...
    public PollAdapter(Context context, ArrayList<PostOption> arrayList) {
...
//        List<Article> articleList = new ArrayList<Article>();
    ...
    public PollAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                       int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isVoted) {
                    ((Home) context).selectPoll(arrayList.get(position).getId());
                }
