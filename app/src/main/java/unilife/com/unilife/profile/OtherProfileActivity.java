...
public class OtherProfileActivity extends BaseActivity {
    ...
    protected void onViewReady(Bundle savedInstanceState, Intent intent) {
        ...
        experienceAdapter = new ExperienceAdapter(mContext, 2);
        achievementAdapter = new AchievementAdapter(mContext, 2);
        educationAdapter = new EducationAdapter(mContext, 2);
    ...
    private void setUpData(ProfileResponse profileResponse1) {
        ...
        regularTextView.setText(profileResponse.getSelfIntroduction().getUsername());
        txtName.setText(profileResponse.getSelfIntroduction().getUsername());
        txtAbout.setText(profileResponse.getSelfIntroduction().getOrganisation() + " at " + profileResponse.getSelfIntroduction().getDesignation());
...
//        Glide.with(this).load(selfIntoduction.getProfileImage()).into(imgProfile);
    ...
    public void openFacebook(View view) {
        if (profileResponse.getRespoonse().getUserSocialProfile().get(0).getFacebook().contains("http")) {
    ...
    public void openInsta(View view) {
        if (profileResponse.getRespoonse().getUserSocialProfile().get(0).getInstagram().contains("http")) {
    ...
    public void openSharechat(View view) {
        if (profileResponse.getRespoonse().getUserSocialProfile().get(0).getSnapchat().contains("http")) {
    ...
    public void openTwitter(View view) {
        if (profileResponse.getRespoonse().getUserSocialProfile().get(0).getTwitter().contains("http")) {
...
//
        showProgressDialog();
        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        Call<CommonResponse> call = apiInterface.profileUpdate2(PreferenceFile.getInstance().getPreferenceData(this, KEY_USERID), updateProfileRequest);
    ...
    public void onChooseFile(View view) {
        CropImage.activity().start(OtherProfileActivity.this);
    }
    ...
    public void openLinkedIn(View view) {
        if (profileResponse.getRespoonse().getUserSocialProfile().get(0).getLinkedin().contains("http")) {
