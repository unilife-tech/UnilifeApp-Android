...
public class LanguageAdapter extends RecyclerView.Adapter<LanguageAdapter.MyViewHolder> {
    ...
    public void updateData(ArrayList<UserLanguage> arrayList) {
    ...
    @Override
    public LanguageAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.textView.setText(arrayList.get(position).getLanguageName());
    }
