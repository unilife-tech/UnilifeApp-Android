...
import unilife.com.unilife.blogs.response.Slider;
...
public class BlogPagerAdapter extends PagerAdapter {
    ...
    ArrayList<BannerResponse.Datum> arrayList=new ArrayList<>();

    public BlogPagerAdapter(Context context, ArrayList<BannerResponse.Datum> arrayList){
