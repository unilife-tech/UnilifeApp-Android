...
public class BlogSubAdapter extends RecyclerView.Adapter<BlogSubAdapter.MyViewHolder> {
    ArrayList<CategoriesBlog> categoriesBlogs;
    Context context;

    // Provide a suitable constructor (depends on the kind of dataset)
    public BlogSubAdapter(Context context, ArrayList<CategoriesBlog> categoriesBlogs) {
    ...
    @Override
    public BlogSubAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
