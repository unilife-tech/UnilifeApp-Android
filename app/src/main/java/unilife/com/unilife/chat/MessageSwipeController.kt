...
class MessageSwipeController(private val context: Context,
    ...
    override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
        ...
        shareRound = context.getDrawable(R.drawable.circle)!!
...
//        shareRound.colorFilter = PorterDuffColorFilter(ContextCompat.getColor(context, R.color.golden), PorterDuff.Mode.MULTIPLY)
    ...
    private fun convertTodp(pixel: Int): Int {
        return Common.dp(pixel.toFloat(), context)
    }
