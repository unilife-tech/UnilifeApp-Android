...
public class GroupChatDetailsAdapter extends RecyclerView.Adapter<GroupChatDetailsAdapter.MyViewHolder> {
    ...
    public void addNewData(Datum chatDatum, RecyclerView recyclerView) {
        ...
        ((GroupChatDetailsActivity) mContext).runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public GroupChatDetailsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_group_chat_details, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (((GroupChatDetailsActivity) mContext).senderId.equals(arrayList.get(position).getSenderId())) {
            //================= OUTGOING MESSAGE ====================
            ...
            holder.txtSenderNameOG.setText(((GroupChatDetailsActivity)mContext).senderName);
...
//                if (EmojiUtils.containsEmoji(arrayList.get(position).getMessage())) {
                String decode = "";
                try {
...
//                } else {
//                    holder.txtMessageOG.setText(arrayList.get(position).getMessage());
//                }
                ...
                Glide.with(mContext)
                        .load(PROFILE_IMAGE_URL + arrayList.get(position).getSenderUserChat().getProfileImage())
                        .apply(defultImg)
                        .into(holder.imgProfileAudioOG);

//                PlayAudio.Companion.setMediaPlayer(holder.seekbarOG, holder.playAudioOG, holder.pauseAudioOG, CHAT_MEDIA_URL + arrayList.get(position).getMessage(), holder.txtAudioDurationOG, arrayList, position);
...
//                        intent.putExtra("file_type", "media");
            ...
            holder.txtSenderName.setText(arrayList.get(position).getSenderUserChat().getUsername());
            if (arrayList.get(position).getChatId() != null) {
...
//        holder.clReplay.setVisibility(View.VISIBLE);
//        if (((GroupDetailsActivity) mContext).senderId.equals(chatDatum.getSenderId())) {
        holder.txtSenderNameReplayOG.setText(chatDatum.getSenderUserChat().getUsername());
//        } else {
//            holder.txtSenderNameReplayOG.setText(((GroupDetailsActivity) mContext).receiver_name);
//        }
...
//        holder.clReplay.setVisibility(View.VISIBLE);
//        if (((GroupDetailsActivity) mContext).senderId.equals(chatDatum.getSenderId())) {
        holder.txtSenderNameReplay.setText(chatDatum.getSenderUserChat().getUsername());
//        } else {
//            holder.txtSenderNameReplay.setText(((GroupDetailsActivity) mContext).receiver_name);
//        }
